using Fastchannel.HttpClient.Bndes.Models.Operations.Request;
using Fastchannel.HttpClient.Bndes.Models.Operations.Response;
...
using OrderPayment = Fastchannel.HttpClient.Bndes.Models.Operations.Request.OrderPayment;
