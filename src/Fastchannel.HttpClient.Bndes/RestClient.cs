...
namespace Fastchannel.HttpClient.Bndes
{
    public class RestClient : IDisposable
    {
        ...
        private System.Net.Http.HttpClient HttpClient => EnsureHttpClientCreated();
        ...
        private System.Net.Http.HttpClient EnsureHttpClientCreated()
        {
            ...
            _httpClient = new System.Net.Http.HttpClient(httpHandler)
            {
